...
import { IItemCart } from '../../store/slices/cartSlice';
                ...
                <div className="header__content">
                    <Link to='/'>
                        <div className="header__logo">
                            <img src="./static/img/pizza.png" alt="pizza-logo" />
                    ...
                    <div className="header__basket basket">
                        <div className="basket__sum">
                            <Link to='/cart' className='basket__info'>{pricePizza} РУБ.</Link>
                        </div>
                        <div className="basket__count">
                            ...
                            <Link to='/cart' className='basket__info'>{countPizza}</Link>
                        </div>
                    </div>
                </div>
            </div>
